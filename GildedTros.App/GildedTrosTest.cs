...
namespace GildedTros.App
{
    public class GildedTrosTest
    {
		...
		public void NormalItem()
		{
			var sellIn = 10;
			var quality = 8;
			var result = this.ExecuteTest(_normalItemName, sellIn, quality);
		...
		public void GoodWine()
		{
			var sellIn = 10;
			var quality = 8;
			var result = this.ExecuteTest(_goodWineItemName, sellIn, quality);
		...
		public void BDAWGKeychain()
		{
			var sellIn = 10;
			var quality = 8;
			var result = this.ExecuteTest(_keychainItemName, sellIn, quality);
		...
		public void BackstagePasses()
		{
			var sellIn = 15;
			var quality = 10;
			var result = this.ExecuteTest(_backstagePassesItemName, sellIn, quality);
		...
		public void SmellyItem()
		{
			var sellIn = 20;
			var quality = 10;
			var result = this.ExecuteTest(_smellyItemName, sellIn, quality);
